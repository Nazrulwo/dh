...
class List extends Component {
  constructor(props) {
    ...
    let items = JSON.parse(realUser).items;
  ...
  sideLinks = [
    ...
    { name: 'EventList', type: 'component', value: 'Component2', category: 1 },
    { name: 'Promptness', type: 'component', value: 'Component3', category: 1 },
    { name: 'Notice', type: 'component', value: 'Component9', category: 1 },
    { name: 'Simulation', type: 'component', value: 'Component5', category: 1 },
    { name: 'Form', type: 'component', value: 'Component5', category: 1 },
    { name: 'Personal', type: 'component', value: 'Component7', category: 1 },
    { name: 'EventList', type: 'component', value: 'Component3', category: 1 },
    { name: 'Notice', type: 'component', value: 'Component9', category: 1 },
    { name: 'Simulation', type: 'component', value: 'Component5', category: 1 },
    { name: 'Form', type: 'component', value: 'Component5', category: 1 },
    { name: 'Personal', type: 'component', value: 'Component7', category: 1 },
    ...
    { name: 'Travelerlist', type: 'component', value: 'Component8', category: 2 },
    { name: 'Decision', type: 'component', value: 'Component3', category: 2 },
    { name: 'Analysis', type: 'component', value: 'Component1', category: 2 },
    { name: 'Transfers', type: 'component', value: 'Component6', category: 2 },
    { name: 'Travelerlist', type: 'component', value: 'Component8', category: 2 },
    { name: 'Personal', type: 'component', value: 'Component7', category: 3 },
    { name: 'Simulation', type: 'component', value: 'Component5', category: 3 },
    { name: 'Promptness', type: 'component', value: 'Component2', category: 3 },
    { name: 'Transfers', type: 'component', value: 'Component6', category: 3 },
    { name: 'Cities', type: 'component', value: 'Component8', category: 3 },
    { name: 'Personal', type: 'component', value: 'Component5', category: 3 },
    { name: 'Analysis', type: 'component', value: 'Component1', category: 4 },
    { name: 'Transfers', type: 'component', value: 'Component3', category: 4 },
    { name: 'Cities', type: 'component', value: 'Component8', category: 4 },
    { name: 'Personal', type: 'component', value: 'Component7', category: 4 },
    { name: 'Simulation', type: 'component', value: 'Component5', category: 4 },
  ];
  category = 1;
  componentDidMount() {
  ...
  onAddTab = () => {
    ...
    if (tabs.length < 5) {
      var tabindex;
      switch (tabs.length) {
        case 1: tabindex = translateCell("select_train"); break;
        case 2: tabindex = translateCell("search_train"); break;
        case 3: tabindex = translateCell("location_time"); break;
        case 4: tabindex = translateCell("event_list"); break;
      }
      tabs.push({
        id: Math.random(),
        name: tabindex,
              ...
              {_.map(items, (item, index) => {
                return (
                  <TabPanel key={tabs[index]['id']}>
                    <div className="contentArea"><h3>Welcome to Support</h3></div>
                    
                    {/* <CardGrid items={item} isEditingCard={this.state.isEditingCard} onRemoveItem={this.onRemoveItem} /> */}
                  </TabPanel>
                );
              })}
            </Tabs>
